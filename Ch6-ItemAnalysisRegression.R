#-----------------------------------------------------------------
# Chapter 5 - Item analysis with regression models
...
#-----------------------------------------------------------------
# 5.3  Models for continuous items
#-----------------------------------------------------------------
#-----------------------------------------------------------------
...
#-----------------------------------------------------------------
# 5.4.2  Other link functions, probit regression model
#-----------------------------------------------------------------
#--------------
# probit link
...
#-----------------------------------------------------------------
# 5.4.4  Nonlinear regression models
#-----------------------------------------------------------------
...
#-----------------------------------------------------------------
# 5.5  Models for polytomous items
#-----------------------------------------------------------------
#-----------------------------------------------------------------
# 5.5.1  Ordinal regression models
#-----------------------------------------------------------------
...
#-----------------------------------------------------------------
# 5.7  Model selection and model fit
#-----------------------------------------------------------------
...
fit_glm1PL <- glm(rating ~ -1 + item + zscore,
                  data = HCI.long,
                  family = binomial
)
coef(fit_glm1PL)
...
#-------------- 
HCI.long$predict1pl <- predict(fit_glm1PL)
plot(HCI.long$zscore, HCI.long$predict1pl,
     xlim = c(-4, 4), ylim = c(-4, 4),
     xlab = "Z-score", ylab = "1PL predicted")
#--------------
...
#-----------------------------------------------------------------
# 5.9. Regression models in interactive application
#-----------------------------------------------------------------
